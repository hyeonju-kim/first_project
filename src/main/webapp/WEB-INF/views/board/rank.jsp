...
<script>
    ...
    function createChart() {
        Highcharts.chart('container', {
            ...
            xAxis: {
                categories: ['삐까삐까', '나난', '미저리', '주이조아', 'Mexico City', 'Dhaka', 'Cairo', 'Beijing', 'Mumbai', 'Osaka', 'Karachi', 'Chongqing', 'Istanbul', 'Buenos Aires', 'Kolkata', 'Kinshasa', 'Lagos', 'Manila', 'Tianjin', 'Guangzhou'],
                title: {
                    text: ''
                },
                labels: {
