    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        var calendar = new FullCalendar.Calendar(calendarEl, {
            ...
            dayCellContent: function (arg) {
                ...
                var isoDate = arg.date.toISOString(); //2023-09-30T15:00:00.000Z
                var dateStr = isoDate.split('T')[0]; // 날짜 부분만 추출
                var value = dietRecordMap[dateStr]; // 해당 날짜에 대한 value 가져오기 (적정/부족/과다)
                ...
                var helloHtml = '<div class="hello-text">' + (value ? value : '') + '</div>'; // value가 있으면 출력, 없으면 빈 문자열 출력
                return { html: dateHtml + helloHtml };
            },
